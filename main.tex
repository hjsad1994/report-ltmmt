...
% ----- GEMINI'S DEFINITIVE SECTION FORMATTING -----
% Goal: No number for sections, but keep numbering for subsections (1, 2, 3...).
\setcounter{secnumdepth}{3} % Make sure numbering is active down to subsubsections.
\titleformat{\section}
  {\normalfont\Large\bfseries} % format
  {} % label (empty for no number)
  {0em} % sep
  {}
\renewcommand{\thesubsection}{\arabic{subsection}} % subsection numbering style
% ----- END OF GEMINI'S FORMATTING -----
...
% Section numbers are disabled by providing an empty label in titleformat.
% Subsection numbering is enabled and set to a simple arabic counter.
